...
$(document).ready(function(){
	$("#remove-btn").click(function(e){
		...
		// #modify-form의 action attr 값을 바꿔야함
	...
	<div class="container-sm">
		...
		<div class="row">
			<div class="col-12 col-lg-6 offset-lg-3">
				...
				<form id="modify-form" method="post" action="${root}/board/modify" <%-- action="${pageContext.request.contextPath }/board/register" --%>>
		
					<div class="form-group">
						<label for="input3">번호</label> <input name="bno" readonly value='<c:out value="${board.bno }"/>' type="text"
					...
					<button id="remove-btn" type="submit" class="btn btn-primary">삭제</button>
				</form>
			</div>
		</div>
	</div>
